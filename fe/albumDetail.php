        ...
        <div class="header__actions">
            ...
            <form action="" method="post">
                <div class="login-form">
                    <a class="login-form-btn" type="submit" href="./login.html">Đăng nhập</a>
                    <div class="avartar-user" onclick="toggleMenu()">
                        <img src="./img/artists/artist1.jpg"/>
                        <div class="avatar-menu">
                            <a href="#" class="logout-menu-user">Logout</a>
                            <a href="./profile.html" class="profile-menu-user">Profile</a>
                        </div>
                    </div>
                </div>
...
<div class="sidebar" style="width: 20%;">
    ...
    <ul class="sidebar__nav">
        <li class="sidebar__nav-item">
            <a href="index.html" class="sidebar__nav-link index"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24">
                    <path
                        d="M20,8h0L14,2.74a3,3,0,0,0-4,0L4,8a3,3,0,0,0-1,2.26V19a3,3,0,0,0,3,3H18a3,3,0,0,0,3-3V10.25A3,3,0,0,0,20,8ZM14,20H10V15a1,1,0,0,1,1-1h2a1,1,0,0,1,1,1Zm5-1a1,1,0,0,1-1,1H16V15a3,3,0,0,0-3-3H11a3,3,0,0,0-3,3v5H6a1,1,0,0,1-1-1V10.25a1,1,0,0,1,.34-.75l6-5.25a1,1,0,0,1,1.32,0l6,5.25a1,1,0,0,1,.34.75Z">
                    </path>
                </svg> <span>Trang chủ</span></a>
        </li>

        <li class="sidebar__nav-item">
            <a href="singers.html" class="sidebar__nav-link artists"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24">
                    <path
        ...
        <li class="sidebar__nav-item">
            <a href="./albums.html" class="sidebar__nav-link releases"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24">
                    <path
                        d="M21.65,2.24a1,1,0,0,0-.8-.23l-13,2A1,1,0,0,0,7,5V15.35A3.45,3.45,0,0,0,5.5,15,3.5,3.5,0,1,0,9,18.5V10.86L20,9.17v4.18A3.45,3.45,0,0,0,18.5,13,3.5,3.5,0,1,0,22,16.5V3A1,1,0,0,0,21.65,2.24ZM5.5,20A1.5,1.5,0,1,1,7,18.5,1.5,1.5,0,0,1,5.5,20Zm13-2A1.5,1.5,0,1,1,20,16.5,1.5,1.5,0,0,1,18.5,18ZM20,7.14,9,8.83v-3L20,4.17Z" />
                </svg> <span>Album nhạc</span></a>
        </li>
        <li class="sidebar__nav-item">
            <a href="contacts.html" class="sidebar__nav-link contacts"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24">
                    <path
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="footer__tagline">Chào mừng bạn đến với trang web âm nhạc của chúng tôi. Hãy sẵn sàng để
                    đắm chìm trong thế giới âm nhạc đa dạng và tận hưởng những giai điệu tuyệt vời.</p>
                <div class="footer__links">
                    <a href="mailto:support@volna.com"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
            ...
            <div class="col-md">
                <h6 class="footer__title">Các trang</h6>
                <div class="footer__nav">
                    <a href="./index.html">Trang chủ</a>
                    <a href="./singers.html">Nghệ sĩ</a>
                    <a href="./albums.html">Album nhạc</a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="footer__content">
                    ...
                    <small class="footer__copyright">© Volna, 2023. Thiết kế bởi nhóm 7</small>
                </div>
            </div>
        </div>
    </div>
