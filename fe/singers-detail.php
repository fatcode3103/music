<?php
include_once "../be/classes/artist.php";

$singer = new Artist();
$singerId = $_GET['singerID'];

$detail = $singer->getSingerById($singerId);
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/fe/css/singers-detail.css" />
        <link rel="stylesheet" href="/fe/css/bootstrap-reboot.min.css" />
        <link rel="stylesheet" href="/fe/css/bootstrap-grid.min.css" />
    ...
    <body>
        ...
        <header class="header">
            <div class="header__content">
                ...
                <form action="querry.html" class="header__search">
                    <input
                        type="text"
                        placeholder="Nghệ sĩ, album hoặc bài hát"
                        name="q"
                    />
                    <button type="button">
                        <svg
                    ...
                    <div class="login-form">
                        ...
                        <div class="avartar-user" onclick="toggleMenu()">
                            ...
                            <div class="avatar-menu">
                                ...
                                <a href="#" class="profile-menu-user"
                                    >Profile</a
                                >
                            </div>
                        </div>
        ...
        <div class="sidebar" style="width: 20%">
            ...
            <ul class="sidebar__nav">
                <li class="sidebar__nav-item">
                    <a href="/fe/index.html" class="sidebar__nav-link index"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        >
                ...
                <li class="sidebar__nav-item">
                    <a href="/fe/singers.html" class="sidebar__nav-link artists"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        >
                ...
                <li class="sidebar__nav-item">
                    <a href="/fe/albums.html" class="sidebar__nav-link releases"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        >
                        ...
                        <span>Album nhạc</span></a
                    >
                </li>
                <li class="sidebar__nav-item">
                    <a
                        href="/fe/contacts.html"
                        class="sidebar__nav-link contacts"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        >
            ...
            <div class="container-fluid">
                        ...
                        <div class="article article--page">
                            ...
                            <div class="article__content">
                                <div class="article__artist">
                                    <img src="<?php echo $detail[0]["image"]; ?> " alt="ảnh" />
                                    <div>
                                        <h1><?php echo $detail[0]["stage_name"]; ?></h1>
                                        <span><?php echo $detail[0]["si_name"]; ?></span>
                                        <p><?php echo $detail[0]["subtitle"]; ?></p>
                                    </div>
                                </div>
                ...
                <section class="row row--grid">
                    ...
                    <div class="col-6 col-sm-4 col-lg-2">
                        ...
                        <script>
                let singerResult = document.querySelector(".artists-container");

                async function layDuLieuNgheSi() {
                    try {
                        const phanHoi = await fetch("../be/getSinger.php");
                        const singers = await phanHoi.json();
                        return singers;
                    } catch (loi) {
                        console.error('Lỗi khi lấy dữ liệu nghệ sĩ:', loi);
                        return [];
                    }
                }

                (async () => {
                    const singers = await layDuLieuNgheSi();

                    singers.forEach((item) => {
                        singerResult.innerHTML += `
                        <div class="artist">
                            <a href="./singers-detail.php?singerID=${item.singer_id}" class="artist" >
                                <img src="${item.image}" alt="Nghệ sĩ 1">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="footer__tagline">
                            Chào mừng bạn đến với trang web âm nhạc của chúng
                            tôi. Hãy sẵn sàng để đắm chìm trong thế giới âm nhạc
                            đa dạng và tận hưởng những giai điệu tuyệt vời.
                        </p>
                        <div class="footer__links">
                            <a href="mailto:support@volna.com"
                                ><svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                >
                    ...
                    <div class="col-12">
                        <div class="footer__content">
                            ...
                            <small class="footer__copyright"
                                >© Volna, 2023. Thiết kế bởi nhóm 7</small
                            >
                        </div>
                    </div>
                </div>
